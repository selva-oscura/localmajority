  ...
  const demographicData = [
    {
      ...
      data: [
        ...
        {label: "Native American or Pacific Islander", value: 2.5, color:"#FFD600"},
  ...
  const politicalData = [
    {
      ...
      data: [
        ...
        {label: "Others", value: .7, color:"grey"},
      ]
    },
    {
      ...
      <div className="row">
        <div className="two-thirds">
    	   <h2>{district.title}</h2>
      		<img src={`../${district.imgSrc}`} alt={`district ${districtId}`} />
    		</div>
        {candidate ? (
          <div className="one-third">
            <h2>{candidate.title}</h2>
            <img src={`../${candidate.imgSrc}`} alt={`district candidate ${candidate.title}`} />
          </div>
        ): null}
    	</div>
      <div className="row">
